(function(module) {
	...
	theme.init = function(params, callback) {
		...
		app.get('/admin/plugins/career', middleware.admin.buildHeader, renderAdmin);
		app.get('/api/admin/plugins/career', renderAdmin);
	...
	theme.addAdminNavigation = function(header, callback) {
		header.plugins.push({
			route: '/plugins/career',
			icon: 'fa-paint-brush',
			name: 'Career Design Theme'
		});
	...
	function renderAdmin(req, res, next) {
		res.render('admin/plugins/career', {});
	}
